...
import cn.itaka.service.ICustomerWalletFlowService;
import cn.itaka.pojo.domain.CustomerWalletFlow;
...
public class CustomerWalletFlowController{
    ...
    @PostMapping
    public R<Void> save(@RequestBody @Valid CustomerWalletFlow customerWalletFlow){
    ...
    @PutMapping
    public R<Void> update(@RequestBody  @Valid CustomerWalletFlow customerWalletFlow){
